...
//I had difficulty passing test 8-14, but it was because my syntax was a bit wrong for the children properties. It tried to create the names using the (.) and use .name to create the property and set it equal to a value at the same time which did not work. Once I changed around the syntax it worked fine.

// How difficult was it to add and delete properties outside of the object itself?
//It wasn't difficult at all and I aprreciate that it is easy to add properties outside of the object.

// What did you learn about manipulating objects in this challenge?
//This reminded me of hashes in ruby and learning how to manipulate and nest objects will be really helpful.
//
//
//
//
